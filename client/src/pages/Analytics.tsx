...
const transformConsumptionData = (events: any[], devices: Device[], timeRange: string): ChartData[] => {
...
export default function Analytics() {
  ...
  const chartData = useMemo(() => transformConsumptionData([], devices || [], timeRange), [devices, timeRange]);
